...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // DON'T show content initially - it stays hidden until lamp slides off
  // content.classList.add('visible'); // REMOVED THIS LINE
});

// Slide lamp off when string is clicked
...
function toggleLamp() {
  ...
  if (isVisible) {
    ...
    setTimeout(() => {
      content.classList.add('visible'); // NOW show content
